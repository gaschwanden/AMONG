...
public class Auction implements Comparable<Auction>{
	...
	/**
	 * Method to register a Bid for this Auction. 
	 * Creates a new Bid corresponding to the Bidder and the amount bid.
	 * @param h The Household that registers a Bid for this Auction.
	 * @param amount The amount the Household bids on the Property advertised in the Auction.
	 */
	...
	/**
	 * The Bid corresponding to a particular Household will be removed from the list of Bids for this Auction.
	 * @param h The household whose Bid will be removed from the list of Bids.
	 */
