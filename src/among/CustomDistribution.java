...
/**
 * Class to provide real-world data to the simulation
 * Provides randomly drawn household income, assets and property value data
...
public class CustomDistribution {
	...
	//for reference: http://www.stat.cmu.edu/~cshalizi/350/lectures/28/lecture-28.pdf
